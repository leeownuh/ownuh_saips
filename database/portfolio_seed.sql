...
('usr-001-0000-0000-0000-000000000001', 'Sophia Johnson',  'sophia.johnson@ownuh-saips.com',  'superadmin', 'active',    1, 'email_otp', 0, NULL,                         NOW() - INTERVAL 22 MINUTE, '203.0.113.10',  'SG', NOW() - INTERVAL 14 DAY, 1, NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 180 DAY, NOW() - INTERVAL 22 MINUTE),
...
('ses-001-0000-0000-0000-000000000001', 'usr-001-0000-0000-0000-000000000001', SHA2('session_demo_superadmin_1', 256), '203.0.113.10',  'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',             'fp_superadmin_laptop', 'email_otp', NOW() - INTERVAL 40 MINUTE, NOW() + INTERVAL 7 HOUR,  NOW() - INTERVAL 3 MINUTE,  NULL, NULL, NULL),
...
('AUTH-001', 'Successful Login',      'usr-001-0000-0000-0000-000000000001', '203.0.113.10',  'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', 'SG', 'device_superadmin_1', 'email_otp',    15, JSON_OBJECT('session_id', 'ses_demo_001', 'trust_level', 'known_device'), NULL, NULL, NOW() - INTERVAL 8 HOUR,  SHA2('portfolio-audit-001', 256), NULL),
...
('AUTH-001', 'Successful Login',      'usr-001-0000-0000-0000-000000000001', '203.0.113.125', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',           'SG', 'device_sophia_ops',    'email_otp',    12, JSON_OBJECT('session_id', 'ses_demo_019', 'trust_level', 'known_device'), NULL, NULL, NOW() - INTERVAL 6 DAY,  SHA2('portfolio-audit-019', 256), SHA2('portfolio-audit-018', 256)),
...
('AUTH-001', 'Successful Login',      'usr-001-0000-0000-0000-000000000001', '203.0.113.118', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',           'SG', 'device_sophia_q2',    'email_otp',    14, JSON_OBJECT('session_id', 'ses_demo_029', 'trust_level', 'known_device'), NULL, NULL, NOW() - INTERVAL 42 DAY, SHA2('portfolio-audit-029', 256), SHA2('portfolio-audit-028', 256)),
...
('AUTH-001', 'Successful Login',      'usr-001-0000-0000-0000-000000000001', '203.0.113.127', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)',           'SG', 'device_sophia_q4',    'email_otp',    13, JSON_OBJECT('session_id', 'ses_demo_040', 'trust_level', 'known_device'), NULL, NULL, NOW() - INTERVAL 128 DAY, SHA2('portfolio-audit-040', 256), SHA2('portfolio-audit-039', 256)),
