...
('usr-001-0000-0000-0000-000000000001', 'Sophia Johnson',  'sophia.johnson@acme.com',  'superadmin', 'active',    1, 'fido2',     0, NULL,                         NOW() - INTERVAL 22 MINUTE, '203.0.113.10',  'SG', NOW() - INTERVAL 14 DAY, 1, NOW() - INTERVAL 120 DAY, NOW() - INTERVAL 180 DAY, NOW() - INTERVAL 22 MINUTE),
('usr-002-0000-0000-0000-000000000002', 'Marcus Chen',     'marcus.chen@acme.com',     'admin',      'active',    1, 'totp',      0, NULL,                         NOW() - INTERVAL 48 MINUTE, '198.51.100.22', 'IN', NOW() - INTERVAL 21 DAY, 1, NOW() - INTERVAL 118 DAY, NOW() - INTERVAL 175 DAY, NOW() - INTERVAL 48 MINUTE),
('usr-003-0000-0000-0000-000000000003', 'Priya Patel',     'priya.patel@acme.com',     'manager',    'locked',    1, 'totp',      6, NOW() - INTERVAL 45 MINUTE,  NOW() - INTERVAL 2 DAY,     '198.51.100.40', 'IN', NOW() - INTERVAL 35 DAY, 1, NOW() - INTERVAL 110 DAY, NOW() - INTERVAL 170 DAY, NOW() - INTERVAL 40 MINUTE),
('usr-004-0000-0000-0000-000000000004', 'James Harris',    'james.harris@acme.com',    'user',       'active',    1, 'email_otp', 0, NULL,                         NOW() - INTERVAL 3 HOUR,    '203.0.113.45',  'AE', NOW() - INTERVAL 30 DAY, 1, NOW() - INTERVAL 100 DAY, NOW() - INTERVAL 165 DAY, NOW() - INTERVAL 3 HOUR),
('usr-005-0000-0000-0000-000000000005', 'Alex Rivera',     'alex.rivera@acme.com',     'user',       'pending',   0, 'none',      0, NULL,                         NULL,                       NULL,            NULL, NULL,                    0, NULL,                    NOW() - INTERVAL 2 DAY,   NOW() - INTERVAL 2 DAY),
('usr-006-0000-0000-0000-000000000006', 'Nina Schultz',    'nina.schultz@acme.com',    'user',       'active',    1, 'totp',      0, NULL,                         NOW() - INTERVAL 5 HOUR,    '203.0.113.91',  'DE', NOW() - INTERVAL 11 DAY, 1, NOW() - INTERVAL 95 DAY,  NOW() - INTERVAL 160 DAY, NOW() - INTERVAL 5 HOUR),
('usr-007-0000-0000-0000-000000000007', 'Omar Farouk',     'omar.farouk@acme.com',     'manager',    'active',    1, 'fido2',     0, NULL,                         NOW() - INTERVAL 9 HOUR,    '198.51.100.54', 'EG', NOW() - INTERVAL 8 DAY,  1, NOW() - INTERVAL 90 DAY,  NOW() - INTERVAL 158 DAY, NOW() - INTERVAL 9 HOUR),
('usr-008-0000-0000-0000-000000000008', 'Ava Thompson',    'ava.thompson@acme.com',    'user',       'suspended', 0, 'none',      3, NOW() - INTERVAL 1 DAY,      NOW() - INTERVAL 12 DAY,    '203.0.113.144', 'US', NOW() - INTERVAL 60 DAY, 1, NOW() - INTERVAL 80 DAY,  NOW() - INTERVAL 150 DAY, NOW() - INTERVAL 1 DAY),
('usr-009-0000-0000-0000-000000000009', 'Rahul Mehta',     'rahul.mehta@acme.com',     'user',       'active',    1, 'email_otp', 0, NULL,                         NOW() - INTERVAL 36 MINUTE, '198.51.100.88', 'IN', NOW() - INTERVAL 18 DAY, 1, NOW() - INTERVAL 75 DAY,  NOW() - INTERVAL 145 DAY, NOW() - INTERVAL 36 MINUTE),
('usr-010-0000-0000-0000-000000000010', 'Lucia Alvarez',   'lucia.alvarez@acme.com',   'admin',      'active',    1, 'email_otp', 0, NULL,                         NOW() - INTERVAL 6 HOUR,    '203.0.113.73',  'ES', NOW() - INTERVAL 12 DAY, 1, NOW() - INTERVAL 70 DAY,  NOW() - INTERVAL 140 DAY, NOW() - INTERVAL 6 HOUR);
...
('alr-001-0000-0000-0000-000000000001', 'Brute-Force Alert',          'AUTH-002', 'email',   5, 15, 'soc@acme-demo.local',         1, NOW() - INTERVAL 35 MINUTE, 'usr-001-0000-0000-0000-000000000001', NOW() - INTERVAL 90 DAY),
...
('priya.patel@acme.com',   '198.54.117.212', 0, 'bad_password', 92, NOW() - INTERVAL 52 MINUTE),
('priya.patel@acme.com',   '198.54.117.212', 0, 'bad_password', 94, NOW() - INTERVAL 50 MINUTE),
('priya.patel@acme.com',   '198.54.117.212', 0, 'bad_password', 95, NOW() - INTERVAL 48 MINUTE),
('priya.patel@acme.com',   '198.54.117.212', 0, 'bad_password', 97, NOW() - INTERVAL 46 MINUTE),
('priya.patel@acme.com',   '198.54.117.212', 0, 'account_locked', 98, NOW() - INTERVAL 44 MINUTE),
('marcus.chen@acme.com',   '198.51.100.22', 1, NULL,           18, NOW() - INTERVAL 6 HOUR),
('rahul.mehta@acme.com',   '198.51.100.88', 1, NULL,           12, NOW() - INTERVAL 40 MINUTE),
('james.harris@acme.com',  '203.0.113.45',  1, NULL,           15, NOW() - INTERVAL 3 HOUR),
('ava.thompson@acme.com',  '203.0.113.144', 0, 'suspended',    76, NOW() - INTERVAL 1 DAY),
('alex.rivera@acme.com',   '198.51.100.101',0, 'pending_user', 42, NOW() - INTERVAL 2 DAY);
...
('AUTH-002', 'Failed Login Attempt',  NULL,                                   '198.54.117.212', 'python-requests/2.31 demo',                         'US', NULL,                  NULL,           94, JSON_OBJECT('username', 'priya.patel@acme.com', 'reason', 'bad_password', 'attempt', 4), NULL, NULL, NOW() - INTERVAL 50 MINUTE, SHA2('portfolio-audit-003', 256), SHA2('portfolio-audit-002', 256)),
...
('AUTH-002', 'Failed Login Attempt',  NULL,                                  '45.83.64.19',   'curl/8.4.0',                                          'DE', NULL,                  NULL,           89, JSON_OBJECT('username', 'admin@legacy.local', 'reason', 'credential_stuffing'), NULL, NULL, NOW() - INTERVAL 33 DAY, SHA2('portfolio-audit-009', 256), SHA2('portfolio-audit-008', 256)),
...
('AUTH-002', 'Failed Login Attempt',  NULL,                                  '91.108.4.200',  'python-requests/2.31',                                'RU', NULL,                  NULL,           91, JSON_OBJECT('username', 'marcus.chen@acme.com', 'reason', 'geo_denied'), NULL, NULL, NOW() - INTERVAL 141 DAY, SHA2('portfolio-audit-014', 256), SHA2('portfolio-audit-013', 256)),
